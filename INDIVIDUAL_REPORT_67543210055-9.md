...
- **กลุ่ม:** Sec2-3
- **หน้าที่:** Backend, Security & Infrastructure Engineer

---

## 🛠️ 2. ส่วนที่รับผิดชอบ (Scopes of Responsibility)
Backend & API Development
- Microservices Architecture: ออกแบบและพัฒนาโครงสร้างพื้นฐานของระบบ โดยแยกการทำงานเป็น Auth Service (จัดการผู้ใช้งาน) และ Task Service (จัดการข้อมูลงาน) เพื่อความอิสระในการ Scale และการจัดการ
...
- **Containerization** ออกแบบและจัดการไฟล์ docker-compose.yml พร้อมทั้งเขียน Dockerfile สำหรับทุก Microservices เพื่อให้ระบบทำงานร่วมกันได้อย่างเป็นเอกเทศผ่าน Docker Network
...
- **End-to-End Testing:** รับผิดชอบการทดสอบ Unit Testing และ Integration Testing ของ API ทั้งหมด (T1 - T11)
